...
int _movieEstimateSize(
  ...
  bytesCount += 3 + object.posterPath2.length * 3;
...
void _movieSerialize(
  ...
  writer.writeString(offsets[9], object.posterPath2);
...
Movie _movieDeserialize(
  ...
  final object = Movie(
    ...
    posterPath2: reader.readString(offsets[9]),
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2EqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'posterPath2',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2GreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2LessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2Between(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2StartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2EndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2Contains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2Matches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2IsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'posterPath2',
        value: '',
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> posterPath2IsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'posterPath2',
        value: '',
...
extension MovieQuerySortBy on QueryBuilder<Movie, Movie, QSortBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> sortByPosterPath2() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'posterPath2', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> sortByPosterPath2Desc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'posterPath2', Sort.desc);
    });
  }
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenByPosterPath2() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'posterPath2', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenByPosterPath2Desc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'posterPath2', Sort.desc);
    });
  }
...
extension MovieQueryWhereDistinct on QueryBuilder<Movie, Movie, QDistinct> {
  ...
  QueryBuilder<Movie, Movie, QDistinct> distinctByPosterPath2(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'posterPath2', caseSensitive: caseSensitive);
    });
  }
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  ...
  QueryBuilder<Movie, String, QQueryOperations> posterPath2Property() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'posterPath2');
    });
  }
