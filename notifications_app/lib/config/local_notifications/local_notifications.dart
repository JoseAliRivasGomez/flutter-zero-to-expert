...
class LocalNotifications {
  ...
  static Future<void> initializeLocalNotifications() async {
    ...
    const initializationSettingsAndroid =
        AndroidInitializationSettings('app_icon'); //el icono esta en android/app/src/main/res/drawable
  ...
  static void showLocalNotification({
    ...
    const androidDetails = AndroidNotificationDetails(
        ...
        playSound: true, 
        sound: RawResourceAndroidNotificationSound('notification'), //el mp3 esta en android/app/src/main/res/raw
